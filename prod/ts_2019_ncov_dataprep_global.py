...
for df, metric in [(confirmed, 'confirmed'), (deaths, 'deaths'), (recovered, 'recovered')]:
    load_job = loader.load_df(df, 'stanleysfang.surveillance_2019_ncov.ts_2019_ncov_{geo}_{metric}_raw'.format(geo=geo, metric=metric), schema=schema)
    load_job.result()
...
for dt_col in dt_cols:
    ...
    FULL JOIN `stanleysfang.surveillance_2019_ncov.ts_2019_ncov_{geo}_recovered_raw` c
